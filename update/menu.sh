...
UPDATE="https://raw.githubusercontent.com/bezzo9699/sc-crot/main/update/update.sh"
GREEN='\033[0;32m'
RED='\033[0;31m'
ipsaya=$(wget -qO- ipinfo.io/ip)
data_server=$(curl -v --insecure --silent https://google.com/ 2>&1 | grep Date | sed -e 's/< Date: //')
date_list=$(date +"%Y-%m-%d" -d "$data_server")
data_ip="https://raw.githubusercontent.com/bezzo9699/crot/main/ip"
checking_sc() {
...
Exp=$(curl -sS https://raw.githubusercontent.com/bezzo9699/crot/main/ip | grep $MYIP | awk '{print $3}')
fi
